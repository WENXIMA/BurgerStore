...
if (isset($_POST['uname']) && isset($_POST['password'])
    && isset($_POST['pnum']) && isset($_POST['re_password'])) {
	...
	$name = validate($_POST['pnum']);

	$user_data = 'uname='. $uname. '&pnum='. $pnum;
	...
	if (empty($uname)) {
		...
		if (mysqli_num_rows($result) > 0) {
           ...
           $sql2 = "INSERT INTO users(user_name, password, pnum) VALUES('$uname', '$pass', '$pnum')";
